...
This project involves testing the [Mock Fake API](https://mockapi.io/projects/66bf916342533c4031468872) using various tools and technologies including **Jenkins, and **RestAssured*. The purpose is to automate the testing of API endpoints to ensure their reliability and performance.
